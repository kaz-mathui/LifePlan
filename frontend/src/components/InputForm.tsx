    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      <div className="space-y-6">
        ...
        <FormSection title="詳細設定">
             <p className="text-sm text-slate-500 -mt-2 mb-4">住宅、教育、車などの大きな支出をより詳細にシミュレーションに反映できます。</p>
            <div className="space-y-4">
                <FormSection title="住宅ローン">
                    <div className="space-y-4 p-4 bg-slate-50 rounded-b-lg border border-t-0">
                ...
                <FormSection title="教育費">
                    <div className="space-y-4 p-4 bg-slate-50 rounded-b-lg border border-t-0">
                        ...
                        {input.education.hasChildren && (
                            <div className="space-y-4">
                                <InputField type="number" label="1人あたりの年間生活費" name="childLivingCost" value={input.education.childLivingCost} onChange={(e) => onNestedChange('education', 'childLivingCost', e.target.value)} unit="万円" description="教育費とは別に、子供が独立するまでにかかる食費や衣類などの基本的な生活費です。" />
        ...
        <FormSection title="ライフイベント" defaultOpen={true}>
            <div className="space-y-4">
